...
public class SmallRoomFactory : AbstractRoomFactory
{
	...
	protected override void setUp()
	{
		...
		Positions exam1 = new Positions("Exam room");
		...
		Positions exam2 = new Positions("Surgery room");
		...
		Positions closet = new Positions("Bathroom");
		...
		Positions hallway = new Positions("Sprinkler room");
